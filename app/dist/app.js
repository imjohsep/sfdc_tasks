...
var _jsxFileName = "/Users/jwatters/Code/quip/sfdc_auth/src/root.jsx";
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentWillMount() {
            ...
            (0, _service.fetchTask)(this.auth).then(function (resp) {
                return resp.json();
            }).then(function (task) {
                console.table(task);
...
_quip2.default.apps.initialize({
    initializationCallback: function initializationCallback(rootNode) {
        ...
        var auth = _quip2.default.apps.auth("sfdc_auth_oauth");
        ReactDOM.render(React.createElement(App, { auth: auth, __source: {
                fileName: _jsxFileName,
                lineNumber: 50
            },
            __self: this
...
var _jsxFileName = "/Users/jwatters/Code/quip/sfdc_auth/src/Client.jsx";
...
var SalesforceClient = exports.SalesforceClient = function () {
    function SalesforceClient(auth) {
        ...
        // auth.login()
        // .then(response => {
        var instanceUrl = auth.getTokenResponseParam("instance_url");
        var task_id = "00Tf400000EiQxNEAV";
        var url = instanceUrl + "/services/data/v39.0/sobjects/Task/" + task_id;
        var access_token = auth.getTokenResponseParam('access_token');
        fetch(url, {
            method: 'GET',
            mode: 'cors',
            headers: {
...
var fetchTask = exports.fetchTask = function fetchTask(auth) {
    var instanceUrl = auth.getTokenResponseParam("instance_url");
    var task_id = "00Tf400000EiQxNEAV";
    var url = instanceUrl + "/services/data/v39.0/sobjects/Task/" + task_id;
    var access_token = auth.getTokenResponseParam('access_token');
